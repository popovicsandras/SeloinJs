...
import ScopedProviderResolver from './ScopedProviderResolver';
...
export default class Injector {
    ...
    resolveProvider(serviceName) {
        let scopedProviderResolver = new ScopedProviderResolver(this, this.resolver, serviceName);
        return scopedProviderResolver.resolveOn(this);
    }
